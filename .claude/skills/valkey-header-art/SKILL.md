...
Read [DESIGN.md](../../../DESIGN.md) first. It is the review rubric: twelve principles, the blind
read that gates them, and the review procedure to walk before committing. This file is the how;
DESIGN.md is the standard the result is held to.
