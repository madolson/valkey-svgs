...
| `tooling-recombine` | One primitive called out, wired to a chain, a cycle and a tree built from copies of it | The same primitive reused across different tools |
...
39 are geometry only and reproduce anywhere.
